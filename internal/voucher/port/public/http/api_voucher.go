...
// @Param sobId path string true "Sob ID"
// @Param id path string true "Voucher ID"
// @Param PostVoucherRequest body PostVoucherRequest true "Post voucher request, poster user ID"
// @Success 204
// @Failure 500 {object} Error
...
func InitRouter(h Handler, r *gin.RouterGroup) {
	...
	r.POST("/sob/:sobId/voucher/:id/review", h.Review)
	r.POST("/sob/:sobId/voucher/:id/cancel-review", h.CancelReview)
	r.POST("/sob/:sobId/voucher/:id/post", h.Post)
}
