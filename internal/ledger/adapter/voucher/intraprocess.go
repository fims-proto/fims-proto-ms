...
func (s IntraprocessAdapter) CheckVoucherPosted(ctx context.Context, voucherUUID uuid.UUID) (bool, error) {
	return s.voucherInterface.CheckVoucherPosted(ctx, voucherUUID)
}
