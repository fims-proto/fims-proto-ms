...
var doc = `{
            ...
            "get": {
                ...
                "responses": {
                    ...
                    "500": {
                        "description": "Internal Server Error",
                        "schema": {
                            "$ref": "#/definitions/internal_ledger_port_public_http.Error"
                        }
                    }
                }
            }
    ...
    "definitions": {
        ...
        "http.LedgerResponse": {
            ...
            "properties": {
                "account": {
                    "$ref": "#/definitions/internal_ledger_port_public_http.AccountResponse"
                },
                "createdAt": {
                    "type": "string"
                },
        ...
        "internal_account_port_public_http.AccountResponse": {
            "type": "object",
            "properties": {
                "accountNumber": {
                    "type": "string"
        ...
        "internal_ledger_port_public_http.AccountResponse": {
            "type": "object",
            "properties": {
                "accountNumber": {
                    "type": "string"
        ...
        "internal_ledger_port_public_http.Error": {
            "type": "object",
            "properties": {
                "message": {
                    "type": "string"
